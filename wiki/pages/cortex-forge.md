...
- CI: `bin/check-skill-sync.sh` + `.github/workflows/skill-sync.yml` — 7 cross-skill consistency invariants verified on push (includes `colocated-script-exists`, added 2026-07-03 to catch scripts a skill references but doesn't actually ship)
